<template>
  <el-dialog
    ...
    <el-form ref="formRef" :model="formData" :rules="rules" size="mini">
      ...
      <el-form-item label="价格" prop="price">
        <el-input v-model.number="formData.price" autocomplete="off" type="number"></el-input>
      </el-form-item>
      <el-form-item label="库存">
        <el-input v-model.number="formData.stock" autocomplete="off" type="stock"></el-input>
      </el-form-item>
      <el-form-item label="月销">
        <el-input v-model.number="formData.monthSale" autocomplete="off" type="number"></el-input>
      </el-form-item>
      <el-form-item label="评分" prop="rate">
        <el-input v-model.number="formData.rate" autocomplete="off" type="number"></el-input>
      </el-form-item>
      <el-form-item label="优先级" prop="rate">
        <el-input v-model.number="formData.index" autocomplete="off" type="number"></el-input>
      </el-form-item>
      <el-form-item label="状态" prop="state">
        <el-select v-model="formData.state" placeholder="选择分类">
          <el-option
              label="下架"
              value="OFF">
          </el-option>
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button
          ...
          type="primary"
          @click="handleCreateNewGoods">确 定
      </el-button>
    </div>
  </el-dialog>
</template>
