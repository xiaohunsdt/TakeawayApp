...
public class WechatUtils {
    ...
    public static AccessibilityNodeInfo findViewId(AccessibilityService accessibilityService, String id, int index) {
    ...
    public static void findViewIdAndClick(AccessibilityService accessibilityService, String id, int index) {
        ...
        List<AccessibilityNodeInfo> nodeInfoList = accessibilityNodeInfo.findAccessibilityNodeInfosByViewId(id);
        if (nodeInfoList != null && !nodeInfoList.isEmpty() && nodeInfoList.size() > index) {
            AccessibilityNodeInfo nodeInfo = nodeInfoList.get(index);
            if (nodeInfo != null) {
                performClick(nodeInfo);
                return;
            }
     ...
     * @param content
     */
    public static void pastContent(AccessibilityService accessibilityService, AccessibilityNodeInfo nodeInfo, String content) throws InterruptedException {
        Bundle arguments = new Bundle();
