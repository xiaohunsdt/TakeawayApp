...
public class MybatisPlusConfig {
    ...
    public MybatisPlusInterceptor mybatisPlusInterceptor() {
        ...
        interceptor.addInnerInterceptor(new TenantLineInnerInterceptor(new TenantLineHandler() {
            final List<String> ignoreTable = List.of("`admin`", "`user`", "`address`", "`activity`", "`banner`", "`specification`", "`produce_spec`", "`goods`", "`goods_stock`", "`order_detail`","`order_item`", "`store`", "`store_balance`", "`store_balance_log`", "`store_withdraw`");
